    ...
    <body class="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 antialiased font-sans flex flex-col justify-between selection:bg-emerald-500 selection:text-white transition-colors duration-150">
        ...
        <main class="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 flex flex-col items-center text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl mt-12 text-left">
                <!-- Nasabah Portal Card -->
                <div class="relative group overflow-hidden rounded-3xl bg-white dark:bg-zinc-900/90 border border-zinc-200 dark:border-zinc-800 p-8 shadow-xl dark:shadow-2xl hover:border-emerald-500/50 transition-all flex flex-col justify-between">
                    ...
                    <div>
                        <div class="size-12 rounded-2xl bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mb-5 border border-emerald-500/20">
                        ...
                        <p class="text-xs sm:text-sm text-zinc-600 dark:text-zinc-400 mt-2">
                            Cek saldo tabungan terkini, lihat riwayat setor & penarikan, serta unduh / cetak rekening koran mutasi tabungan secara langsung.
                        </p>
                ...
                <div class="relative group overflow-hidden rounded-3xl bg-white dark:bg-zinc-900/90 border border-zinc-200 dark:border-zinc-800 p-8 shadow-xl dark:shadow-2xl hover:border-zinc-400 dark:hover:border-zinc-700 transition-all flex flex-col justify-between">
                    ...
                    <div>
                        <div class="size-12 rounded-2xl bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-200 flex items-center justify-center mb-5 border border-zinc-300 dark:border-zinc-700">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-6" viewBox="0 0 20 20" fill="currentColor">
